    ...
    public BotMessage processa(MensagemInterna message) {
        ...
        return new BotMessage(contexto).withMessages(
                new QuickReplyComponentBotMessage("Antes de seguirmos para o seu perfil, me diga, o que você procura?",
                        new QuickReplyButton("Preciso de ajuda para resolver problema(s)", TipoUsuario.CLIENTE.getTipo()),
                        new QuickReplyButton("Quero ajudar a resolver problemas", TipoUsuario.SOLUCIONADOR.getTipo())
                )
        );
    }
}

    ...
    return new BotMessage(contexto)
        .withMessages(
            new TextComponentBotMessage(
                "Olá, Eu Sou a Helena! Consultora e especialista da Incluitec."),
            new TextComponentBotMessage(
                "Vi que é sua primeira vez por aqui, então antes de começarmos, "
            ...
            new QuickReplyComponentBotMessage(
                ...
                new QuickReplyButton(
                    "Email e Telefone", TipoContato.EMAIL_E_TELEFONE.getPropriedade())));
  }
}
